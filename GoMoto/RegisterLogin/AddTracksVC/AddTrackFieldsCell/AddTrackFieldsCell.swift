...
class AddTrackFieldsCell: UITableViewCell, NibLoadable, ReusableView {
    ...
    @IBAction func createButtonAction(_ sender: Any) {
        ...
        let user_id = user.id
        let track = Track(id: nil, name: name, adress: adress, postcode: postcode, latitude: latitude, longitude: longitude, soil_type: soil_type, opening_times: opening_times, prices: prices, child_friendly: child_friendly, rating: 0.0, user_id: user_id, featured: 0, image: trackProfileImageUrl)
